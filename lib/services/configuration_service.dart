...
class ConfigurationService {
  ...
  double get cryScoreThreshold =>
      _prefs.getDouble('${_generalPrefix}cry_score_threshold') ?? 0.65;
  ...
  Future<void> setMotionMinDurationMs(int durationMs) =>
      _prefs.setInt('${_generalPrefix}motion_min_duration_ms', durationMs);
  Future<void> setCryScoreThreshold(double threshold) =>
      _prefs.setDouble('${_generalPrefix}cry_score_threshold', threshold);
  Future<void> setCryMinDurationMs(int durationMs) =>
      _prefs.setInt('${_generalPrefix}cry_min_duration_ms', durationMs);
