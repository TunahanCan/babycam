...
import 'server/mimicam_event_socket_controller.dart';
import 'server/mimicam_http_dispatcher.dart';
...
part 'server/mimicam_server_media_controllers.dart';
...
class MimiCamServer {
  MimiCamServer({
    ...
    _eventSockets = MimiCamEventSocketController(
      activeClients: _activeClientRegistry,
  ...
  late final MimiCamEventSocketController _eventSockets;
  ...
  late final MimiCamHttpDispatcher _httpDispatcher;
  ...
  Future<({bool ok, String? clientId})> _authorizeRoute(
    ...
    switch (mode) {
      case MimiCamRouteAuthMode.none:
...
typedef _AuthMode = MimiCamRouteAuthMode;
typedef _RouteSpec = MimiCamHttpRoute;
