...
class MimiCamDesignTokens {
  ...
  static const serverInk = Color(0xFF06283F);
  static const serverNavy = Color(0xFF087A9A);
  static const serverPanel = Color(0xFF0C5D78);
  static const serverCyan = Color(0xFF45F4DE);
  static const serverCyanDeep = Color(0xFF17CFC4);
  static const serverBlue = Color(0xFF20B8F2);
  static const serverViolet = Color(0xFF73F0C9);
  static const serverIce = Color(0xFFF0FFFC);
