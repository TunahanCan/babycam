  ...
  MediaQualityProfile adaptForClientLoad(int activeVideoClients) {
    if (activeVideoClients >= 4) {
      return copyWith(
        ...
        jpegQuality: jpegQuality > 50 ? 50 : jpegQuality,
        cameraPresetKey: 'medium',
        audioFirst: true,
      );
    }
    if (activeVideoClients >= 2) {
      return copyWith(
        id: 'shared_balanced_480p',
        label: '$label / paylaşımlı',
        width: width > 854 ? 854 : width,
        height: height > 480 ? 480 : height,
        targetFps: targetFps > 8 ? 8 : targetFps,
        jpegQuality: jpegQuality > 56 ? 56 : jpegQuality,
        cameraPresetKey: 'medium',
        audioFirst: true,
      );
    }
