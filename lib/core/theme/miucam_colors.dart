...
class MiuCamColors {
  static const brandBlue = Color(0xFF5B5BD6);
  static const brandBlueDark = Color(0xFF4343B8);
  static const brandBlueSoft = Color(0xFFF1F2FF);
  static const brandPink = Color(0xFF7468D7);
  static const brandPinkDark = Color(0xFF5649B7);
  static const brandPinkSoft = Color(0xFFF2F0FF);
  static const background = Color(0xFFF8FAFC);
  static const navy = Color(0xFF162033);
  static const slate = Color(0xFF64748B);
  static const mutedBlue = Color(0xFF9AA9BC);
