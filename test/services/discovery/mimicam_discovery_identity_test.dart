...
import 'package:mimicam/services/discovery/mimicam_discovery_identity.dart';
...
void main() {
  test('discovery identity is created once and survives provider recreation',
    ...
    final identity = PersistentMimiCamDiscoveryIdentity(preferences);
    ...
    final recreated =
        await PersistentMimiCamDiscoveryIdentity(preferences).getOrCreate();
