...
void main() {
  ...
  test('reads signed extremes', () {
    final b = ByteData(4)..setInt16(0, 32767, Endian.little)..setInt16(2, -32768, Endian.little);
    expect(Pcm16LeReader.readMonoSamples(b.buffer.asUint8List()), [32767, -32768]);
  });
  ...
  test('stereo averages to mono', () {
    final b = ByteData(4)..setInt16(0, 1000, Endian.little)..setInt16(2, -500, Endian.little);
    expect(Pcm16LeReader.readMonoSamples(b.buffer.asUint8List(), channels: 2).single, 250);
  });
