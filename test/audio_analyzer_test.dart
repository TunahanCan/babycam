...
void main() {
  test('high mid-band sustained tone increases cry score', () {
    ...
    final chunk =
        _sinePcm16(frequency: 470, amplitude: 0.45, sampleRate: 16000);
  ...
  test('low sustained tone increases moan score', () {
    final analyzer = AudioAnalyzer(sampleRate: 16000);
    final chunk =
        _sinePcm16(frequency: 260, amplitude: 0.40, sampleRate: 16000);
...
Uint8List _sinePcm16(
  ...
  for (var i = 0; i < sampleCount; i++) {
    final sample =
        (sin(2 * pi * frequency * i / sampleRate) * amplitude * 32767).round();
