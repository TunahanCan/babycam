...
android {
    ...
    defaultConfig {
        ...
        // Read Telegram credentials from gradle.properties
        val telegramBotToken = project.findProperty("telegram.bot_token")?.toString() ?: ""
        val telegramChatId = project.findProperty("telegram.chat_id")?.toString() ?: ""
