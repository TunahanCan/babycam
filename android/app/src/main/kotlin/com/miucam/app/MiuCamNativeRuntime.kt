...
class PcmAudioPlayer(private val context: Context) {
    ...
    private val noisyReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            MiuCamPlatformRuntime.setAudioOutputActive(
                false,
                "audio_becoming_noisy"
            )
            MiuCamPlatformRuntime.emit("audioBecomingNoisy")
        }
    }
    ...
    private fun pauseForFocusLoss(change: Int) {
        ...
        pausedForFocusLoss = true
        audioTrack?.pause()
        MiuCamPlatformRuntime.setAudioOutputActive(false, "audio_focus_lost")
        MiuCamPlatformRuntime.emit(
            "audioFocusLost",
    ...
    private fun resumeAfterFocusGain() {
        ...
        MiuCamPlatformRuntime.emit("audioFocusGained")
    }
