...
class MiuCamForegroundService : LifecycleService(),
    ...
    private var mediaCapture: MiuCamServiceMediaCapture? = null
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (action) {
            ACTION_STOP -> {
                ...
                if (MiuCamPlatformRuntime.hasRequestedRuntimeDemand) {
        ...
        if (
            ...
            MiuCamPlatformRuntime.setForegroundServiceFailure(
        ...
        val engine = MiuCamEngineOwner.claimForService()
    ...
    private fun releaseRuntime(reason: String) {
        ...
        alertDemand = false
        serverDemand = false
        MiuCamEngineOwner.releaseService()
        MiuCamPlatformRuntime.setForegroundServiceState(
            active = false,
            camera = false,
            microphone = false,
            playback = false,
    ...
    private fun reconcileNativeMediaCapture() {
        ...
        val capture = mediaCapture ?: MiuCamServiceMediaCapture(
            applicationContext,
            this
    ...
    private fun acquireWifiLock() {
        ...
        wifiLock = wifiManager.createWifiLock(lockMode, "MiuCam:ServerWifiLock").apply {
    ...
    companion object {
        private const val ACTION_START = "com.miucam.app.action.START_SERVER"
        private const val ACTION_UPDATE = "com.miucam.app.action.UPDATE_SERVER"
        private const val ACTION_STOP = "com.miucam.app.action.STOP_SERVER"
        ...
        ): Intent = Intent(context, MiuCamForegroundService::class.java).apply {
            action = ACTION_START
        ...
        fun stopIntent(context: Context): Intent =
            Intent(context, MiuCamForegroundService::class.java).apply {
                action = ACTION_STOP
            }
    }
}
