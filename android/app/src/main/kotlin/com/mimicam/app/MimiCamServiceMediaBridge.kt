 ...
 * [MimiCamForegroundService]. Camera and microphone ownership never moves to
 * the Flutter Activity; Dart only attaches as a consumer of already-owned
 * service media.
 */
object MimiCamServiceMediaBridge : EventChannel.StreamHandler {
    const val METHOD_CHANNEL = "mimicam/android_service_media"
    const val EVENT_CHANNEL = "mimicam/android_service_media_events"
    ...
    fun updateCaptureState(
        ...
        MimiCamPlatformRuntime.setNativeMediaCaptureState(
